drop table if exists stv2023070330__staging.transactions;
create table stv2023070330__staging.transactions(
...
create projection stv2023070330__staging.transactions_b0
...
from stv2023070330__staging.transactions
...
drop table if exists stv2023070330__staging.currencies;
create table stv2023070330__staging.currencies(
    currency_code integer not null,
...
create projection stv2023070330__staging.currencies_b0
